...
router.post('/seed-european', requireAdmin, async (req, res) => {
  try {
    ...
    const seedLeagues = [
      ...
      { name: 'גביע אפריקה לאומות', key: 'africa-cup-of-nations', color: '#0f7b3e', type: 'national', region: 'אפריקה', order: 74, apiFootballId: 6, footballDataCode: null, espnLeagueCode: 'caf.nations', sofaScoreTournamentId: null, sportsDbLeagueId: null, scores365CompetitionId: null, seek365: { names: ['גביע אפריקה לאומות', 'גביע אפריקה', 'אליפות אפריקה', 'Africa Cup of Nations'], exact: ['גביע אפריקה לאומות', 'גביע אפריקה', 'אליפות אפריקה', 'Africa Cup of Nations'], exclude: ['נשים', 'women', 'נוער', 'עד גיל', 'u2', 'u1', 'futsal', 'חופים', 'מוקדמות', 'מקומיים', 'chan'] } },
      // הטורניר עצמו משוחק בדצמבר-ינואר, והמוקדמות שלו הן תחרות נפרדת
      // אצל 365 - זו שמשוחקת בחלונות הנבחרות של ספטמבר ואוקטובר. בלעדיה
      // "גביע אפריקה" מחזיר ריק תשעה חודשים בשנה, וזה נראה כמו תקלה
      { name: 'מוקדמות גביע אפריקה', key: 'africa-cup-qual', color: '#0b5c33', type: 'national', region: 'אפריקה', order: 75, apiFootballId: 29, footballDataCode: null, espnLeagueCode: 'caf.nations_qual', sofaScoreTournamentId: null, sportsDbLeagueId: null, scores365CompetitionId: null, seek365: { names: ['מוקדמות גביע אפריקה', 'מוקדמות אליפות אפריקה', 'מוקדמות אפריקה', 'Africa Cup of Nations Qualification'], exact: ['מוקדמות גביע אפריקה', 'מוקדמות אליפות אפריקה', 'מוקדמות גביע אפריקה לאומות'], exclude: ['נשים', 'women', 'נוער', 'עד גיל', 'u2', 'u1', 'futsal', 'חופים', 'chan', 'מקומיים'] } },
